    ...
    function ComposerFactory (HandlerResolverConstructor, SchemaResolverConstructor, ScopeResolverConstructor) {
        ...
        this.compose = function (config) {
            return new Promise(function (resolve, reject) {
                if (!isInitialized) {
                    return reject('ComposerFactory must be initialized');
                }
        ...
        this.composeRoute = function (config) {
            return new Promise(function (resolve, reject) {
                ...
                Object.keys(routeConfig.methods).forEach(function (method) {
                    ...
                    if (methodConfig.preHandlers) {
                        promises.push(Promise.all((methodConfig.preHandlers instanceof Array ? methodConfig.preHandlers : [methodConfig.preHandlers])
                            .map(handlerResolver.resolve.bind(handlerResolver)))
                            .then(function (results) {
                            methodConfig.preHandlers = results;
                        }));
                    }
                    ...
                    if (methodConfig.validator) {
                        promises.push(schemaResolver.resolve(methodConfig.validator).then(function (result) {
                            methodConfig.validator = result;
                        }));
                    }
